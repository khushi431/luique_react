                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <a target="_blank"  className="scrolla-element-anim-1"
                            title="Github" rel="noopener noreferrer" href="https://github.com/khushi431">
      <i  className="fab fa-github" />
    </a>
    <a target="_blank" rel="noopener noreferrer"  className="scrolla-element-anim-1"
